                ...
                <div class="card wpclever_plugins">
					...
					if ( is_array( $plugins_arr ) && ( count( $plugins_arr ) > 0 ) ) {
						...
						foreach ( $plugins_arr as $pl ) {
							...
							echo '<div class="item"><a href="' . esc_url( 'https://wordpress.org/plugins/' . $pl['slug'] ) . '/" target="_blank"><span class="num">' . $i . '</span><span class="title">' . esc_html( $pl['name'] ) . '</span><br/><span class="info">Version ' . esc_html( $pl['version'] ) . '</span></a></div>';
                            $i ++;
						}
					} else {

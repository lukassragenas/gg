...
! defined( 'WPCSB_VERSION' ) && define( 'WPCSB_VERSION', '1.3.0' );
	...
	function wpcsb_init() {
		...
		if ( ! class_exists( 'WPCleverWpcsb' ) && class_exists( 'WC_Product' ) ) {
			class WPCleverWpcsb {
				...
				function admin_menu() {
					add_submenu_page( 'wpclever', esc_html__( 'WPC Sticky Add To Cart', 'wpc-sticky-add-to-cart' ), esc_html__( 'Sticky Add To Cart', 'wpc-sticky-add-to-cart' ), 'manage_options', 'wpclever-wpcsb', array(
						$this,
						'admin_menu_content'
					) );
				}
                    ...
                    <div class="wpclever_settings_page wrap">
                        ...
                        <div class="wpclever_settings_page_desc about-text">
                            <p>
                                ...
                                | <a
                                        href="<?php echo esc_url( WPCSB_CHANGELOG ); ?>"
                        ...
                        <div class="wpclever_settings_page_nav">
                            <h2 class="nav-tab-wrapper">
                                <a href="<?php echo admin_url( 'admin.php?page=wpclever-wpcsb&tab=settings' ); ?>"
                                   class="<?php echo esc_attr( $active_tab === 'settings' ? 'nav-tab nav-tab-active' : 'nav-tab' ); ?>">
									<?php esc_html_e( 'Settings', 'wpc-sticky-add-to-cart' ); ?>
                                </a>
                                <a href="<?php echo admin_url( 'admin.php?page=wpclever-wpcsb&tab=localization' ); ?>"
                                    ...
                                    <table class="form-table">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" min="0" step="1" class="small-text"
                                                       ...
                                                       value="<?php echo esc_attr( $offset_top ); ?>"/> (px)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" min="0" step="1" class="small-text"
                                                       ...
                                                       value="<?php echo esc_attr( $offset_bottom ); ?>"/> (px)
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="description">If yes, please install <a
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="description">If yes, please install <a
                                                            ...
                                                            class="thickbox" title="Install WPC Smart Compare">WPC Smart Compare</a> to make it work.</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="description">If yes, please install <a
                                                            ...
                                                            class="thickbox" title="Install WPC Smart Wishlist">WPC Smart Wishlist</a> to make it work.</span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <span class="description">If yes, please install <a
                                                            ...
                                                            class="thickbox" title="Install WPC Buy Now Button">WPC Buy Now Button</a> to make it work.</span>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr class="submit">
                                            <th colspan="2">
												<?php settings_fields( 'wpcsb_settings' ); ?>
												<?php submit_button(); ?>
                                            </th>
                                        </tr>
                                    </table>
							...
							<?php } elseif ( $active_tab === 'localization' ) { ?>
                                <form method="post" action="options.php">
                                    <table class="form-table">
                                        ...
                                        <tr class="submit">
                                            <th colspan="2">
												<?php settings_fields( 'wpcsb_localization' ); ?>
												<?php submit_button(); ?>
                                            </th>
                                        </tr>
                                    </table>
				...
				function enqueue_scripts() {
					wp_enqueue_style( 'wpcsb-frontend', WPCSB_URI . 'assets/css/frontend.css', array(), WPCSB_VERSION );
					wp_enqueue_script( 'wpcsb-frontend', WPCSB_URI . 'assets/js/frontend.js', array( 'jquery' ), WPCSB_VERSION, true );
					wp_localize_script( 'wpcsb-frontend', 'wpcsb_vars', array(
                                ...
                                <div class="wpcsb-product-info">
                                    ...
                                    <div class="wpcsb-product-image">
                                        ...
                                        <div class="wpcsb-image-ori">
											<?php
											echo apply_filters( 'wpcsb_product_image', wp_kses( $product->get_image(), array(
												'img' => array(
													'src'   => array(),
													'class' => array(),
													'id'    => array()
										...
										if ( self::get_setting( 'show_price', 'yes' ) === 'yes' ) {
                                            ...
                                            <div class="wpcsb-product-price">
                                                ...
                                                <div class="wpcsb-price-ori">
													<?php
													echo apply_filters( 'wpcsb_product_price', wp_kses( $product->get_price_html(), array(
														'del'  => array(),
														'ins'  => array(),
														'bdi'  => array(),

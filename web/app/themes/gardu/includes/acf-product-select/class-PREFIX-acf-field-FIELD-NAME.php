...
<!-- <input type="number" class="setting-font-size" name="<?php echo esc_attr($field['name']) ?>"
    value="<?php echo esc_attr($field['value']) ?>" style="font-size:<?php echo esc_attr($field['font_size']) ?>px;" /> -->
<select class="js-example-basic-single" name="state">
    <?php
foreach ($all_products as $key => $product) {
            echo '<option value="' . esc_attr($field['value']) . '">' . $product->post_title . '</option>';
        }
        ?>
</select>
<script>

...
?>
    <form method="post"
        class="mt-3 woocommerce-ResetPassword lost_reset_password d-flex flex-column align-items-center">
        ...
        <p
            class=" woocommerce-form-row woocommerce-form-row--first form-row form-row-first text-center d-flex flex-column align-items-center justify-content-center">
        ...
        <p class="woocommerce-form-row form-row text-center">
            ...
            <button type="submit" class="woocommerce-Button button main-btn w-100"

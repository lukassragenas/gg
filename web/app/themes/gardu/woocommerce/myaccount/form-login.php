...
<div class="max-width py-5">
    <div class="u-columns col2-set" id="customer_login">
        ...
        <div class="u-column1 col-1">
            ...
            <h2><span class="first-letter"><?php esc_html_e('Login', 'woocommerce');?></span></h2>
            ...
            <form class="woocommerce-form woocommerce-form-login login" method="post">
                ...
                <p class="form-row d-flex flex-column">
                    <label
                    ...
                    <button type="submit"
                        class="main-btn update-cart woocommerce-button button woocommerce-form-login__submit"
                        name="login"
        ...
        <div class="u-column2 col-2">
            ...
            <form method="post" class="woocommerce-form woocommerce-form-register register"
                ...
                <p>
                    ...
                    <?php esc_html_e('Naujas slaptažodis bus atsiųstas nurodytu el. paštu.', 'woocommerce');?>
                ...
                <p class="woocommerce-form-row form-row">
                    ...
                    <button type="submit"
                        class="main-btn woocommerce-Button woocommerce-button button woocommerce-form-register__submit"
                        name="register"

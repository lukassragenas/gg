...
jQuery(document).ready(function($) {
    ...
    $('.plus').on('click', function(e) {
        ...
        var max_value = parseInt($(this).prev('input').attr('max'));
        let current_value = $(this).prev('input');
        if (current_value.val() != max_value) {
            current_value.attr('value', val + 1);
    ...
    $('.minus').on('click', function(e) {
        ...
        let current_value = $(this).next('input');
        if (val != 0) {
            current_value.attr('value', val - 1);
            $('.update-cart-btn').prop('disabled', false);
        }
        // current_value.val(val - 1);
    });
    ...
    $('body').on('updated_cart_totals', function() {
        $('.shop_table.cart').closest('form').find('input[name="update_cart"]').prop('disabled',
            false); // this will enable the button.
...
<div class="max-width">
    <div class="py-40 row d-flex">
        <form class="col col-12 col-lg-6 woocommerce-cart-form" action="<?php echo esc_url(wc_get_cart_url()); ?>"
            method="post">
...
?>
                    ...
                    <tr>
                        <td colspan="6" class="actions">
                            ...
                            <div class="coupon">
                                ...
                                <button type="submit" class="button update-cart-btn" name="update_cart"
        ...
        <div class="col col-12 col-lg-6 cart-collaterals">
            <?php
/**
